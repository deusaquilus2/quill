...
trait Unliftables {
  ...
  implicit val queryUnliftable: Unliftable[Query] = Unliftable[Query] {
    case q"$pack.Entity.apply(${ a: String }, ${ b: List[PropertyAlias] }, ${ renameable: Renameable })" => Entity(a, b, renameable)
  ...
  implicit val renameableUnliftable: Unliftable[Renameable] = Unliftable[Renameable] {
    ...
    case q"$pack.Renameable.Internal"   => Renameable.Internal
  }

  implicit val propertyUnliftable: Unliftable[Property] = Unliftable[Property] {
    case q"$pack.Property.apply(${ a: Ast }, ${ b: String }, ${ renameable: Renameable })" => Property(a, b, renameable)
  }
