...
class FlattenGroupByAggregationSpec extends Spec {
  ...
  "flattens mapped aggregation" - {
    "simple" in {
      ...
      FlattenGroupByAggregation(Ident("e", quatOf[TestEntity]))(q.ast.body) mustEqual
    ...
    "nested infix" in {
      ...
      FlattenGroupByAggregation(Ident("e", quatOf[TestEntity]))(q.ast.body) mustEqual n.ast.body
    }
  }
